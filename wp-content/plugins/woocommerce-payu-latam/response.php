...
fbq('init', '562891068199443');
fbq('track', 'PageView');
</script>
<noscript><img height='1' width='1' style='display:none'
src='https://www.facebook.com/tr?id=562891068199443&ev=PageView&noscript=1'
/></noscript>
...
?>
	...
	<div class="row">
						...
						<div class="wpb_wrapper">	
							<div class="wpb_single_image wpb_content_element vc_align_left">		
								<figure class="wpb_wrapper vc_figure">
									<div class="vc_single_image-wrapper   vc_box_border_grey" style="text-align: center;">
										<img width="400" height="254" src="https://naturalconexion.com/wp-content/uploads/2020/09/Logo_Color-2.png" class="vc_single_image-img attachment-full" alt="" srcset="https://www.comercializadorafrenel.com/wp-content/uploads/2021/05/logo-frenel-min.png 800w, https://www.comercializadorafrenel.com/wp-content/uploads/2021/05/logo-frenel-min.png 300w, https://www.comercializadorafrenel.com/wp-content/uploads/2021/05/logo-frenel-min.png 768w" sizes="(max-width: 800px) 100vw, 800px">
									</div>
								</figure>
							</div>
							...
							<div id="title-ok" class="title-wrapper  woodmart-title-color-default woodmart-title-style-simple woodmart-title-width-100 text-center woodmart-title-size-large ">
								<div class="liner-continer">
									...
									<h4 class="woodmart-title-container title  woodmart-font-weight-700">&iexcl;Gracias por tu compra</h4>
		...
		<div style="width: 100%; text-align: center; margin: -1rem 0 2rem 0;">
		    <a href="/shop" title="" class="btn btn-color-primary btn-style-default btn-shape-rectangle btn-size-default">Volver a la tienda</a>
	    </div>
